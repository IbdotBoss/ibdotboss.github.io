...
**Final-year BEng Computer Science** &middot; Anglia Ruskin University, Cambridge  
Email: uthmanibrahimkhalil@gmail.com &middot; GitHub: [ibdotboss](https://github.com/IbdotBoss)  
Phone: +44 7799 823187 &middot; LinkedIn: [iku101](https://linkedin.com/in/iku101)
...
Web tool that interviews users and outputs portable `me.md` identity files. Started from this question: 
...
no backend &mdash; entirely client-side.
...
STM32 Nucleo-G474RE secure entry system using HMAC-SHA256 challenge-response authentication. 
FreeRTOS firmware, Python WebSocket broker, CustomTkinter admin interface.

**Why it matters:** Demonstrates security thinking from silicon to application layer. Hardware-rooted 
trust for physical access control.

**Tech:** C (FreeRTOS), Python, CustomTkinter, WebSocket, STM32, HMAC-SHA256.
...
team of 4; delivered on schedule.
...
**Backend/DevOps:** Flask, Jinja2, Vercel serverless, GitHub Actions, cron automation  
**Embedded:** FreeRTOS, STM32 (C), CustomTkinter, WebSocket  
**Tools:** Git, ServiceNow (Certified System Administrator), Claude Code/Co-Work

---

## Certifications

- Certified System Administrator &mdash; ServiceNow (2024)
- Introduction to Cybersecurity &mdash; Codecademy (2024)
- Introduction to JavaScript &mdash; Codecademy (2024)
- Programming for Everybody (Python) &mdash; Coursera (2022)

---

## Education

**BEng (Hons) Computer Science** &middot; Anglia Ruskin University, Cambridge  
Jan 2024 &ndash; Dec 2026 (final year)

Relevant modules: Software Engineering, Computer Systems and Networking

---

## Design philosophy

Built with intention. No purple gradients, no Inter, no generic emoji icons. 
I write to be understood, not to sound smart. Technical writing should serve 
the work, not decorate it.

---

*This CV intentionally avoids filler phrases like "team player" and "excellent communication skills." 
